...
export default function MeScreen() {
  ...
  // Set Character Modal Visible if race and class are not set
  useEffect(() => {
                  ...
                  {statsData.class && statsData.race && (
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                      <View style={{ flexDirection: 'column' }}>
                        {isRaceConfirmed && (
                          <>
                            <Text style={styles.modalLabel}>Race: {statsData.race}</Text>
                            <ImageBackground
                        ...
                        {isClassConfirmed && <Text style={[styles.modalLabel, { textTransform: 'capitalize' }]}>Class: {statsData.class}</Text>}
